...
Этот проект — упрощенная версия Твиттера (X), созданная в учебных целях. Главная цель — разобраться на практике, как работают микросервисы, как их разрабатывать, обеспечивать безопасность и разворачивать для них окружение.
